...
async function composeExpr(args) {
  ...
  let leftPageShift = new Point(
    ...
    verticalMargin - boundingBox.left * args.scale - args.between - args.left
  );
  let rightPageShift = new Point(
    leftPageShift.x,
    leftPageShift.y + verticalMargin + boundingBox.width * args.scale + 2 * args.between - args.left
  );
...
export default async function print(args) {
